...
def get_mfe(env, residue, mfe_ph, mfe_xts, mfe_pwcut, pKa):
        ...
        if os.path.exists(opp_path):
            ...
            for line in lines:
                ...
                if len(fields) >= 3:
                    ...
                    if len(fields[3]) > 8:
                        fields[3] = fields[3][:-8]
                    pairwise[fields[1]] = float(fields[2]) * scale_ele + float(fields[3]) * scale_vdw # Edit by Gehan/Junjun 01/21/2022
    ...
    print('Note: mfe.py uses Averaged Boltzmannn Distribution Occupancy (aka Recovered Occupancy)')
    print('')
    ...
    print('Ground Conformers: Boltzmann Averaged Distribution Occupancy (Recovered Occupancy)') 
    for conformer in ground_conformers:
        ...
        for i in range(len(titration.range)):
            ...
            print(conformer.name, conformer.rocc)
    print('')
    ...
    print('Excited Conformers: Boltzmann Averaged Distribution Occupancy (Recovered Occupancy)')
